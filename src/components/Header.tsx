...
function Logo() {
  return (
    <Link
      href="/#start"
      className="block h-[clamp(3.75rem,14vw,5.1rem)] w-[clamp(10rem,min(72vw,calc(100vw-7.5rem)),19rem)] shrink-0 sm:h-[4.25rem] sm:w-[280px] md:h-[4.8rem] md:w-[320px] lg:h-[5.2rem] lg:w-[360px]"
    >
      <Image
...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-[100] border-b border-white/10 bg-brand-dark shadow-md">
      <div className="mx-auto flex min-w-0 max-w-[min(100%,88rem)] items-center justify-between gap-3 py-2.5 pl-1 pr-3 pb-3 sm:gap-6 sm:py-2 sm:pb-2.5 sm:pl-3 sm:pr-5 lg:grid lg:grid-cols-[auto_1fr_auto] lg:items-center lg:gap-10 lg:px-6 lg:py-1">
        <div className="min-w-0 flex-1 lg:flex-none lg:min-w-0">
          <Logo />
        </div>

        <nav
          className="hidden lg:flex lg:flex-wrap lg:items-center lg:justify-center lg:gap-x-10"
      ...
      {open ? (
        <div
          id="mobile-menu"
          className="relative z-[110] border-t border-white/10 bg-brand-dark px-3 py-4 sm:px-5 lg:hidden"
        >
