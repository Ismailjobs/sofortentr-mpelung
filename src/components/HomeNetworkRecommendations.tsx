  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[min(100%,88rem)] px-3 sm:px-5 lg:px-6">
        <h2 id="home-network-recommendations" className="sr-only">
          Empfohlener Partner im Netzwerk
        </h2>
        <p className="mx-auto max-w-3xl text-pretty text-center text-sm leading-relaxed text-neutral-600 sm:text-[0.95rem] sm:leading-7">
          Suchen Sie professionelle Räumungsdienste in Wien? Für Wohnungsauflösungen, Entrümpelungen und
          Verlassenschaftsräumungen im Wiener Raum empfehlen wir unseren Partner{" "}
          <a
